...
export const INITIAL_DEMO_LEADS: Lead[] = [
  {
    ...
    place: 'Tripunitura',
    requirement: 'Premium Interior Package',
    platform: 'Reference',
    reference: 'Soumya',
    category: 'interior',
    followUpDate: '01/12/2025',
    status: 'Work awarded',
    status2: 'Completed',
    customFields: {},
  },
  {
    ...
    date: '1/12/2025',
    name: 'Jogy Philip',
    contact: '+91 94471 23456',
    place: 'Kakkanad',
    requirement: 'Grand Interior Package',
    platform: 'Reference',
    reference: 'Self',
    category: 'interior',
    followUpDate: '01/12/2025',
    status: 'Estimate submitted',
    status2: 'under designing',
    customFields: {},
  },
  {
    rowIndex: 4,
  ...
  },
  {
    ...
    slNo: '4',
    date: '1/12/2025',
    name: 'Greeshma/Nitheesh',
    contact: '+91 98950 45678',
    place: 'Tripunitura',
    requirement: 'Premium Plus Interior Package',
    platform: 'Reference',
    reference: 'Nitheesh',
    category: 'interior',
    followUpDate: '01/12/2025',
    status: 'waiting for the design confirmation',
    status2: 'Lost',
    customFields: {},
  },
  {
    ...
    date: '05/12/2025',
    name: 'Sunitha K.V.',
    contact: '+91 94470 54321',
    place: 'Aluva',
    requirement: 'Loose Furniture & Custom Wardrobes',
    platform: 'Instagram',
    reference: 'Ad Campaign',
    category: 'loose Furniture',
    followUpDate: new Date().toLocaleDateString('en-GB'), // Today
    status: 'Estimate submitted',
    status2: 'Follow Up Required',
    customFields: {},
  },
  {
    rowIndex: 7,
    ...
    date: '08/12/2025',
    name: 'Dr. Ramesh Nair',
    contact: '+91 98472 88990',
    place: 'Edappally',
    requirement: 'Full Villa Turnkey Interior',
    platform: 'Reference',
    reference: 'Deepa Teacher',
    category: 'interior',
    followUpDate: new Date().toLocaleDateString('en-GB'), // Today
    status: 'waiting for the design confirmation',
    status2: 'under designing',
  ...
  },
  {
    ...
    date: '10/12/2025',
    name: 'Anand & Revathi',
    contact: '+91 99951 11223',
    place: 'Kaloor',
    requirement: 'Modular Kitchen + Living WI',
    platform: 'Website',
    reference: 'Organic Search',
    category: 'WI',
    followUpDate: '15/12/2025',
    status: 'Estimate submitted',
    status2: 'Discussion Stage',
    customFields: {},
  },
  {
    rowIndex: 9,
    ...
    date: '12/12/2025',
    name: 'Faisal Rahman',
    contact: '+91 97460 33445',
    place: 'Panampilly Nagar',
    requirement: 'Luxury Duplex Premium Plus Interior',
    platform: 'Architect Ref',
    reference: 'Ar. Vishnu',
    category: 'interior',
    followUpDate: '20/12/2025',
    status: 'Work awarded',
    status2: 'In Progress',
    customFields: {},
  },
